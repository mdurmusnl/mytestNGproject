...
public class Day18_Assertions {
    ...
    public void softAssertions(){
      /*
        ...
        System.out.println("Line 34codes");
        softAssert.assertAll("TEST CASE COMPLETED");//assertAll MUST BE USED AT THE END TO MARK THE TEST CASE AS FAIL
        System.out.println("Line haha 38 codes");  //this doest run   assertAll is the last code to be executed
